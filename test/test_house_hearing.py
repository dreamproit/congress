...
class HearingInfo(unittest.TestCase):
    def test_hearing(self):
        ...
        self.assertEqual(
            test_output['topic'],
            'H.R. 4435\u2014National Defense Authorization Act for Fiscal Year 2015 [General Debate]; H.R. 4660\u2014Commerce, Justice, Science, and Related Agencies Appropriations Act, 2015',  # noqa
        )
        self.assertEqual(
            test_output['url'],
    ...
    def test_witnesses(self):
        ...
        self.assertEqual(
            ...
            [
                {
                    'url': 'http://docs.house.gov/meetings/GO/GO25/20140522/102266/HHRG-113-GO25-Bio-CochraneJ-20140522.pdf',  # noqa
                    'file_found': True,
                }
            ],
        )
